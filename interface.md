...
- 用户登录之后会返回token字符串，作为登录的依据
- token有效期为1hour 
- 除了上传及登录接口，所有接口调用之前必须在header中添加“token”=”XXXXXX"
...
> >   9. likes:点赞条数 ，整数
> >   10. comments：评论数量，整数
> >   11. like_me:用户是否点过赞 1true 0false
>
> 五、删除餐品信息
>
> > - **路径**：/menu/delete
...
> >   8. likes： 评论点赞数量 整数
> >   9. likes_me：用户是否点过赞 1true 0 false  
...
> > - **传入参数**：
> > - 1. userId:用户Id 整数
> >   2. type:点赞类型 1为餐品 2为评论 整数
> >   3. typeId:对应的餐品id或评论id  整数
> > - **返回结果**：
> >   1. like_id:对应点赞的id，证明点赞成功
>
> 一、取消点赞
>
> > - **路径**：/like/cancel
